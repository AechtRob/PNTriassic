...
public class BiomeTriassicCreekWarmVolcanicHillsValley extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:triassic_creek_warm_volcanic_hills_valley")
	public static final BiomeGenCustom biome = null;
	public BiomeTriassicCreekWarmVolcanicHillsValley(ElementsLepidodendronMod instance) {
		super(instance, 1589);
	}
	...
	static class BiomeGenCustom extends BiomeTriassic {
		public BiomeGenCustom() {
			...
			super(new BiomeProperties("Triassic Warm Swampy Valleys Creek").setTemperature(3.25F).setRainfall(0.8F).setBaseHeight(-0.525F).setHeightVariation(0.00F).setWaterColor(3906905));
			setRegistryName("lepidodendron:triassic_creek_warm_volcanic_hills_valley");
		...
		public void decorate(World worldIn, Random rand, BlockPos pos)
		{
			...
			if(net.minecraftforge.event.terraingen.TerrainGen.decorate(worldIn, rand, new net.minecraft.util.math.ChunkPos(pos), net.minecraftforge.event.terraingen.DecorateBiomeEvent.Decorate.EventType.GRASS))
				for (int i = 0; i < 3; ++i)
				{
					...
					int k = rand.nextInt(16) + 8;
					int l = rand.nextInt(worldIn.getHeight(pos.add(j, 0, k)).getY() + 32);
					LEAFBLOCK_GENERATOR.generate((BlockBush) BlockPagiophyllumSapling.block, BlockPagiophyllumLeaves.block.getDefaultState(), BlockPagiophyllumLog.block.getDefaultState().withProperty(BlockPagiophyllumLog.BlockCustom.FACING, EnumFacing.NORTH), worldIn, rand, pos.add(j, l, k), 0, 80);
				}
