...
public class BiomeTriassicFloodedForestDense extends ElementsLepidodendronMod.ModElement {
	...
	static class BiomeGenCustom extends BiomeTriassic {
		public BiomeGenCustom() {
			super(new BiomeProperties("Triassic Southern Flooded Forest").setRainfall(0.5F).setBaseHeight(-0.25F).setHeightVariation(0.00F).setTemperature(2.00F).setRainfall(1.5F).setWaterColor(3906905));
			setRegistryName("lepidodendron:triassic_flooded_forest_dense");
