...
public class BiomeTriassicKarooPlains extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:triassic_karoo_plains")
	public static final BiomeGenCustom biome = null;
	public BiomeTriassicKarooPlains(ElementsLepidodendronMod instance) {
		super(instance, 1589);
	}
	...
	static class BiomeGenCustom extends BiomeTriassic {
		public BiomeGenCustom() {
			...
			super(new BiomeProperties("Triassic Southern Plains").setRainfall(0.0F).setBaseHeight(0.02F).setHeightVariation(0.0F).setTemperature(1.5F).setRainDisabled());
			setRegistryName("lepidodendron:triassic_karoo_plains");
