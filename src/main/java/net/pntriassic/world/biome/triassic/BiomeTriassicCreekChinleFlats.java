...
public class BiomeTriassicCreekChinleFlats extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:triassic_creek_chinle_flats")
	public static final BiomeGenCustom biome = null;
	public BiomeTriassicCreekChinleFlats(ElementsLepidodendronMod instance) {
		super(instance, 1591);
	}
	...
	static class BiomeGenCustom extends BiomeTriassic {
		public BiomeGenCustom() {
			super(new BiomeProperties("Triassic Canyon Outflows").setBaseHeight(-0.565F).setHeightVariation(0.0F).setTemperature(0.8F).setRainfall(0.4F).setWaterColor(3906905));
			setRegistryName("lepidodendron:triassic_creek_chinle_flats");
		...
		protected static final WorldGenWoodworthiaTreeWaterDeep WOODWORTHIA_TREE = new WorldGenWoodworthiaTreeWaterDeep(false);
		protected static final WorldGenArboramosaTreeWaterDeep ARBORAMOSA_TREE = new WorldGenArboramosaTreeWaterDeep(false);
		...
		public void decorate(World worldIn, Random rand, BlockPos pos)
		{
			...
			if(net.minecraftforge.event.terraingen.TerrainGen.decorate(worldIn, rand, new net.minecraft.util.math.ChunkPos(pos), DecorateBiomeEvent.Decorate.EventType.GRASS))
				for (int i = 0; i < 2; ++i)
				{
					...
					SCHIZONEURA_GENERATOR.generate(worldIn, rand, new BlockPos(pos.getX() + j, l, pos.getZ() + k), false);
				}
		...
		public EnumBiomeTypeTriassic getBiomeType() {
			return EnumBiomeTypeTriassic.Chinle;
		}
