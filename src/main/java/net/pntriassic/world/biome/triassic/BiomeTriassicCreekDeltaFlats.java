...
public class BiomeTriassicCreekDeltaFlats extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:triassic_creek_delta_flats")
	public static final BiomeGenCustom biome = null;
	public BiomeTriassicCreekDeltaFlats(ElementsLepidodendronMod instance) {
		super(instance, 1591);
	}
	...
	static class BiomeGenCustom extends BiomeTriassic {
		public BiomeGenCustom() {
			super(new BiomeProperties("Triassic Delta").setBaseHeight(-0.565F).setHeightVariation(0.0F).setTemperature(0.8F).setRainfall(0.4F).setWaterColor(3906905));
			setRegistryName("lepidodendron:triassic_creek_delta_flats");
