...
public class BiomeTriassicKarooSwamp extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:triassic_karoo_swamp")
	public static final BiomeGenCustom biome = null;
	public BiomeTriassicKarooSwamp(ElementsLepidodendronMod instance) {
		super(instance, 1589);
	}
	...
	static class BiomeGenCustom extends BiomeTriassic {
		public BiomeGenCustom() {
			...
			super(new BiomeProperties("Triassic Southern Swampy Woods").setRainfall(0.0F).setBaseHeight(-0.06F).setHeightVariation(0.00F).setTemperature(1.5F).setRainDisabled());
			setRegistryName("lepidodendron:triassic_karoo_swamp");
