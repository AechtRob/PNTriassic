...
public class BiomeTriassicLossiemouth extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:triassic_lossiemouth")
	public static final BiomeGenCustom biome = null;
	public BiomeTriassicLossiemouth(ElementsLepidodendronMod instance) {
		super(instance, 1589);
	}
	...
	static class BiomeGenCustom extends BiomeTriassic {
		public BiomeGenCustom() {
			super(new BiomeProperties("Triassic Sandy Hills").setTemperature(3.00F).setRainfall(0.8F).setBaseHeight(0.155F).setHeightVariation(0.152F));
			setRegistryName("lepidodendron:triassic_lossiemouth");
