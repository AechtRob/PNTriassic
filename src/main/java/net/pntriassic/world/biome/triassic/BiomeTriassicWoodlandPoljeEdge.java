...
public class BiomeTriassicWoodlandPoljeEdge extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:triassic_woodland_polje_edge")
	public static final BiomeGenCustom biome = null;
	public BiomeTriassicWoodlandPoljeEdge(ElementsLepidodendronMod instance) {
		super(instance, 1589);
	}
	...
	static class BiomeGenCustom extends BiomeTriassic {
		public BiomeGenCustom() {
			//was height 0.001
			super(new BiomeProperties("Triassic Polje").setBaseHeight(0F).setHeightVariation(0.2F).setTemperature(0.8F).setRainfall(0.9F));
			setRegistryName("lepidodendron:triassic_woodland_polje_edge");
