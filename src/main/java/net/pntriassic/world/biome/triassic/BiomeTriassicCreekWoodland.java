...
public class BiomeTriassicCreekWoodland extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:triassic_creek_woodland")
	public static final BiomeGenCustom biome = null;
	public BiomeTriassicCreekWoodland(ElementsLepidodendronMod instance) {
		super(instance, 1589);
	}
	...
	static class BiomeGenCustom extends BiomeTriassic {
		public BiomeGenCustom() {
			//was height 0.001
			super(new BiomeProperties("Triassic Woodland Creek").setBaseHeight(-0.525F).setHeightVariation(0.0F).setTemperature(0.8F).setRainfall(0.9F));
			setRegistryName("lepidodendron:triassic_creek_woodland");
		...
		public void decorate(World worldIn, Random rand, BlockPos pos)
		{
			...
			if(net.minecraftforge.event.terraingen.TerrainGen.decorate(worldIn, rand, new net.minecraft.util.math.ChunkPos(pos), DecorateBiomeEvent.Decorate.EventType.GRASS))
				for (int i = 0; i < 18; ++i)
				{
					...
					int k = rand.nextInt(16) + 8;
					int l = rand.nextInt(worldIn.getHeight(pos.add(j, 0, k)).getY() + 32);
					PLANT_GENERATOR.generate(BlockWielandiella.block.getDefaultState(), worldIn, rand, pos.add(j, l, k), 60, 80);
				}
