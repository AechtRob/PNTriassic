...
public class BiomeTriassicCreekWarmVolcanicHills extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:triassic_creek_warm_volcanic_hills")
	public static final BiomeGenCustom biome = null;
	public BiomeTriassicCreekWarmVolcanicHills(ElementsLepidodendronMod instance) {
		super(instance, 1589);
	}
	...
	static class BiomeGenCustom extends BiomeTriassic {
		public BiomeGenCustom() {
			super(new BiomeProperties("Triassic Warm Swampy Valleys Creek").setTemperature(3.00F).setRainfall(0.8F).setBaseHeight(-0.525F).setHeightVariation(0.00F).setWaterColor(-5317633));
			setRegistryName("lepidodendron:triassic_creek_warm_volcanic_hills");
