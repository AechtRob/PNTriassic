...
public class BiomeTriassicCreekBeach extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:triassic_creek_coastal")
	public static final BiomeGenCustom biome = null;
	public BiomeTriassicCreekBeach(ElementsLepidodendronMod instance) {
		super(instance, 1591);
	}
	...
	static class BiomeGenCustom extends BiomeTriassic {
		public BiomeGenCustom() {
			super(new BiomeProperties("Triassic Coastal Creek").setBaseHeight(-0.525F).setHeightVariation(0.0F).setTemperature(0.8F).setRainfall(0.4F).setWaterColor(13038245));
			setRegistryName("lepidodendron:triassic_creek_coastal");
