...
public class BiomeTriassicGondwananForestClearingLake extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:triassic_gondwanan_forest_clearing_lake")
	public static final BiomeGenCustom biome = null;
	public BiomeTriassicGondwananForestClearingLake(ElementsLepidodendronMod instance) {
		super(instance, 1589);
	}
	...
	static class BiomeGenCustom extends BiomeTriassic {
		public BiomeGenCustom() {
			super(new BiomeProperties("Triassic Southern Lacustrine Clearing").setTemperature(0.25F).setRainfall(0.8F).setBaseHeight(-0.48F).setHeightVariation(0.15F).setWaterColor(-5317633));
			setRegistryName("lepidodendron:triassic_gondwanan_forest_clearing_lake");
