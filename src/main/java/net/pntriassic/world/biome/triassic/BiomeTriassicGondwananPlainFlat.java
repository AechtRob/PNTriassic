...
public class BiomeTriassicGondwananPlainFlat extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:triassic_gondwanan_plain_flat")
	public static final BiomeGenCustom biome = null;
	public BiomeTriassicGondwananPlainFlat(ElementsLepidodendronMod instance) {
		super(instance, 1589);
	}
	...
	static class BiomeGenCustom extends BiomeTriassic {
		public BiomeGenCustom() {
			super(new BiomeProperties("Triassic Southern Moss Meadows").setTemperature(0.75F).setRainfall(0.8F).setBaseHeight(-0.1F).setHeightVariation(0.00F).setWaterColor(-5317633));
			setRegistryName("lepidodendron:triassic_gondwanan_plain_flat");
		...
		protected static final WorldGenDicroidium DICROIDIUM_Z = new WorldGenDicroidium(false);
		...
		{
			if (rand.nextInt(2) != 0) {return DESMIOPHYLLUM_TREE;}

			if (rand.nextInt(72) == 0) {return PAGIOPHYLLUM_TREE;}
