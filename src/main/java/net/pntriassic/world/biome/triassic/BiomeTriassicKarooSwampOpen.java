...
public class BiomeTriassicKarooSwampOpen extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:triassic_karoo_swamp_open")
	public static final BiomeGenCustom biome = null;
	public BiomeTriassicKarooSwampOpen(ElementsLepidodendronMod instance) {
		super(instance, 1589);
	}
	...
	static class BiomeGenCustom extends BiomeTriassic {
		public BiomeGenCustom() {
			...
			super(new BiomeProperties("Triassic Southern Marsh").setRainfall(0.0F).setBaseHeight(-0.36F).setHeightVariation(0.00F).setTemperature(1.5F).setRainDisabled());
			setRegistryName("lepidodendron:triassic_karoo_swamp_open");
