...
public class BiomeTriassicCreekDesert extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:triassic_creek_desert")
	public static final BiomeGenCustom biome = null;
	public BiomeTriassicCreekDesert(ElementsLepidodendronMod instance) {
		super(instance, 1589);
	}
	...
	static class BiomeGenCustom extends BiomeTriassic {
		public BiomeGenCustom() {
			...
			super(new BiomeProperties("Triassic Desert Creek").setRainfall(0.0F).setBaseHeight(-0.425F).setHeightVariation(0.0F).setTemperature(2.5F).setRainDisabled().setWaterColor(16767282));
			setRegistryName("lepidodendron:triassic_creek_desert");
