...
public class BiomeTriassicChinleFlats extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:triassic_chinle_flats")
	public static final BiomeGenCustom biome = null;
	public BiomeTriassicChinleFlats(ElementsLepidodendronMod instance) {
		super(instance, 1591);
	}
	...
	static class BiomeGenCustom extends BiomeTriassic {
		public BiomeGenCustom() {
			super(new BiomeProperties("Triassic Canyon Outflows").setBaseHeight(-0.133F).setHeightVariation(0.02F).setTemperature(0.8F).setRainfall(0.4F).setWaterColor(3906905));
			setRegistryName("lepidodendron:triassic_chinle_flats");
