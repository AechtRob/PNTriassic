...
public class BiomeTriassicDeltaFlatsMound extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:triassic_delta_flats_mound")
	public static final BiomeGenCustom biome = null;
	public BiomeTriassicDeltaFlatsMound(ElementsLepidodendronMod instance) {
		super(instance, 1591);
	}
	...
	static class BiomeGenCustom extends BiomeTriassic {
		public BiomeGenCustom() {
			super(new BiomeProperties("Triassic Delta Vegetated Mound").setBaseHeight(0.233F).setHeightVariation(0.0F).setTemperature(0.8F).setRainfall(0.4F).setWaterColor(3906905));
			setRegistryName("lepidodendron:triassic_delta_flats_mound");
		...
		protected static final WorldGenAnomozamitesShoot ANOMOZAMITES_SHOOT = new WorldGenAnomozamitesShoot();
		...
		public void decorate(World worldIn, Random rand, BlockPos pos)
		{
			...
			if(net.minecraftforge.event.terraingen.TerrainGen.decorate(worldIn, rand, new net.minecraft.util.math.ChunkPos(pos), DecorateBiomeEvent.Decorate.EventType.GRASS))
				for (int i = 0; i < 9; ++i)
				{
					...
					int k = rand.nextInt(16) + 8;
					int l = rand.nextInt(worldIn.getHeight(pos.add(j, 0, k)).getY() + 32);
					LEAFBLOCK_GENERATOR.generate((BlockBush) BlockElatocladusSapling.block, BlockElatocladusLeaves.block.getDefaultState(), BlockElatocladusLog.block.getDefaultState().withProperty(BlockElatocladusLog.BlockCustom.FACING, EnumFacing.NORTH), worldIn, rand, pos.add(j, l, k), 0, 80);
				}
			...
			if(net.minecraftforge.event.terraingen.TerrainGen.decorate(worldIn, rand, new net.minecraft.util.math.ChunkPos(pos), DecorateBiomeEvent.Decorate.EventType.GRASS))
				for (int i = 0; i < 15; ++i)
				{
					...
					int k = rand.nextInt(16) + 8;
					int l = rand.nextInt(worldIn.getHeight(pos.add(j, 0, k)).getY() + 32);
					ANOMOZAMITES_SHOOT.generate(worldIn, rand, pos.add(j, l, k));
				}
			...
			if(net.minecraftforge.event.terraingen.TerrainGen.decorate(worldIn, rand, new net.minecraft.util.math.ChunkPos(pos), DecorateBiomeEvent.Decorate.EventType.GRASS))
				for (int i = 0; i < 2; ++i)
				{
					...
					int k = rand.nextInt(16) + 8;
					int l = rand.nextInt(worldIn.getHeight(pos.add(j, 0, k)).getY() + 32);
					THINNFELDIA_GENERATOR.generate(worldIn, rand, pos.add(j, l, k));
				}
