...
public class BiomeTriassicHorsetails extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:triassic_horsetails")
	public static final BiomeGenCustom biome = null;
	public BiomeTriassicHorsetails(ElementsLepidodendronMod instance) {
		super(instance, 1589);
	}
