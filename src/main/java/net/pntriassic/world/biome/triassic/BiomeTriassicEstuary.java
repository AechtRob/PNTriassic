...
public class BiomeTriassicEstuary extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:triassic_estuary")
	public static final BiomeGenCustom biome = null;
	public BiomeTriassicEstuary(ElementsLepidodendronMod instance) {
		super(instance, 1591);
	}
	...
	static class BiomeGenCustom extends BiomeTriassic {
		public BiomeGenCustom() {
			super(new BiomeProperties("Triassic Estuary").setBaseHeight(-0.1F).setHeightVariation(0.0F).setTemperature(0.8F).setRainfall(0.4F).setWaterColor(13038245));
			setRegistryName("lepidodendron:triassic_estuary");
