...
public class BiomeTriassicMadagascarFlats extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:triassic_madagascar_flats")
	public static final BiomeGenCustom biome = null;
	public BiomeTriassicMadagascarFlats(ElementsLepidodendronMod instance) {
		super(instance, 1591);
	}
	...
	static class BiomeGenCustom extends BiomeTriassic {
		public BiomeGenCustom() {
			super(new BiomeProperties("Triassic Southern Coast").setBaseHeight(-0.2F).setHeightVariation(0.0F).setTemperature(1.8F).setRainfall(0.4F).setWaterColor(3906905));
			setRegistryName("lepidodendron:triassic_madagascar_flats");
		...
		public void decorate(World worldIn, Random rand, BlockPos pos)
		{
			...
			if(net.minecraftforge.event.terraingen.TerrainGen.decorate(worldIn, rand, new net.minecraft.util.math.ChunkPos(pos), DecorateBiomeEvent.Decorate.EventType.GRASS))
				for (int i = 0; i < 10; ++i)
				{
					...
					PUDDLES_GENERATOR.generate(worldIn, rand, new BlockPos(pos.getX() + j, l, pos.getZ() + k));
				}
