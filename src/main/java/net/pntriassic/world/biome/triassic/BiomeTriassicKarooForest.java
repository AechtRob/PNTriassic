...
public class BiomeTriassicKarooForest extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:triassic_karoo_forest")
	public static final BiomeGenCustom biome = null;
	public BiomeTriassicKarooForest(ElementsLepidodendronMod instance) {
		super(instance, 1589);
	}
	...
	static class BiomeGenCustom extends BiomeTriassic {
		public BiomeGenCustom() {
			...
			super(new BiomeProperties("Triassic Southern Sphenobaiera Forest").setRainfall(0.0F).setBaseHeight(0.86F).setHeightVariation(0.14F).setTemperature(1.5F).setRainDisabled());
			setRegistryName("lepidodendron:triassic_karoo_forest");
