...
public class BiomeTriassicChinaLakes extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:triassic_china_lakes")
	public static final BiomeGenCustom biome = null;

	public BiomeTriassicChinaLakes(ElementsLepidodendronMod instance) {
		super(instance, 1589);
	}
	...
	static class BiomeGenCustom extends BiomeTriassic {
		public BiomeGenCustom() {
			//was height 0.001
			super(new BiomeProperties("Triassic Cathay Lakes").setBaseHeight(-0.3175F).setHeightVariation(0.265F).setTemperature(0.8F).setRainfall(0.9F));
			setRegistryName("lepidodendron:triassic_china_lakes");
			topBlock = BlockSandWhite.block.getDefaultState();
			fillerBlock = BlockSandWhite.block.getDefaultState();
