...
public class GenLayerTriassicEuropeOffshore2 extends GenLayer
{
    ...
    public GenLayerTriassicEuropeOffshore2(long seed, GenLayer genLayer)
    {
        super(seed);
        ...
        for (int i = 0; i < areaHeight; ++i)
        {
            for (int j = 0; j < areaWidth; ++j)
            {
                ...
                if (isOcean(k))
                {
                    ...
                    if (isEuropeForReef(l1) || isEuropeForReef(k2) || isEuropeForReef(j3) || isEuropeForReef(i4))
                    {
                        aint1[j + i * areaWidth] = TRIASSIC_REEF_ID;
                    }
                    else
                    {
    ...
    private boolean isEuropeForReef(int biomeID) {
        Biome biome = Biome.getBiome(biomeID);
        return biome == BiomeTriassicEstuary.biome;
    }
