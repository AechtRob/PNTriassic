...
public class BiomeTriassicWarmVolcanicHillsValley extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:triassic_warm_volcanic_hills_valley")
	public static final BiomeGenCustom biome = null;
	public BiomeTriassicWarmVolcanicHillsValley(ElementsLepidodendronMod instance) {
		super(instance, 1589);
	}
	...
	static class BiomeGenCustom extends BiomeTriassic {
		public BiomeGenCustom() {
			...
			super(new BiomeProperties("Triassic Warm Swampy Valleys").setTemperature(3.25F).setRainfall(0.8F).setBaseHeight(-0.175F).setHeightVariation(0.00F).setWaterColor(3906905));
			setRegistryName("lepidodendron:triassic_warm_volcanic_hills_valley");
