...
public class BiomeTriassicGondwananPlainFlat extends ElementsLepidodendronMod.ModElement {
	...
	static class BiomeGenCustom extends BiomeTriassic {
		public BiomeGenCustom() {
			super(new BiomeProperties("Triassic Temperate Moss Meadows").setTemperature(0.75F).setRainfall(0.8F).setBaseHeight(-0.1F).setHeightVariation(0.00F).setWaterColor(-5317633));
